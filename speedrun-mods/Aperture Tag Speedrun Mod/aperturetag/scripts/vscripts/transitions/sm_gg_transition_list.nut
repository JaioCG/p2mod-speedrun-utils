...
LAST_PLAYTEST_MAP <- "sm_gg_all_unnamed"


CHAPTER_TITLES <- 
[
	{ map = "sm_gg_blue_only", title_text = "#at_Chapter1_Title", subtitle_text = "#at_Chapter1_Subtitle", displayOnSpawn = false,	displaydelay = 1.0 },
	{ map = "sm_gg_red_only", title_text = "#at_Chapter2_Title", subtitle_text = "#at_Chapter2_Subtitle", displayOnSpawn = true,	displaydelay = 1.0 },
	{ map = "sm_gg_a2_column_blocker", title_text = "#at_Chapter3_Title", subtitle_text = "#at_Chapter3_Subtitle", displayOnSpawn = true,	displaydelay = 1.0 },
	{ map = "sm_gg_stage_reveal", title_text = "#at_Chapter4_Title", subtitle_text = "#at_Chapter4_Subtitle", displayOnSpawn = true,	displaydelay = 1.0 },
]
